...
contract DSCEngineTest is StdCheats, Test {
    ...
    function testRevertsIfTokenLengthDoesntMatchPriceFeeds() public {
        ...
        new DSCEngine(tokenAddresses, feedAddresses, dsc);
    }
    ...
    function testRevertsIfTransferFromFails() public {
        ...
        vm.prank(owner);
        DSCEngine mockDsce = new DSCEngine(tokenAddresses, feedAddresses, dsc);
    ...
    function testRevertsIfCollateralZero() public {
        ...
        vm.expectRevert(DSCEngine.DSCEngine__CollateralAmountCantBeZero.selector);
    ...
    function testRevertsWithUnapprovedCollateral() public {
        ...
        vm.startPrank(user);
        vm.expectRevert(abi.encodeWithSelector(DSCEngine.DSCEngine__TokenAddressNotAllowed.selector, address(randToken)));
    ...
    function testRevertsIfMintFails() public {
        ...
        address owner = msg.sender;
        vm.prank(owner);
        DSCEngine mockDsce = new DSCEngine(tokenAddresses, feedAddresses, mockDsc);
    ...
    function testRevertsIfMintAmountIsZero() public {
        ...
        ERC20Mock(weth).approve(address(dsce), amountCollateral);
        dsce.depositCollateralAndMintDsc(weth, amountCollateral, amountToMint);
        vm.expectRevert(DSCEngine.DSCEngine__MintAmountCantBeZero.selector);
        dsce.mintDsc(0);
        vm.stopPrank();
    }
    ...
    function testRevertsIfBurnAmountIsZero() public {
        ...
        ERC20Mock(weth).approve(address(dsce), amountCollateral);
        dsce.depositCollateralAndMintDsc(weth, amountCollateral, amountToMint);
        vm.expectRevert(DSCEngine.DSCEngine__BurnAmountCantBeZero.selector);
        dsce.burnDsc(0);
        vm.stopPrank();
    }
    ...
    function testRevertsIfRedeemAmountIsZero() public {
        ...
        ERC20Mock(weth).approve(address(dsce), amountCollateral);
        dsce.depositCollateralAndMintDsc(weth, amountCollateral, amountToMint);
        vm.expectRevert(DSCEngine.DSCEngine__RedeemAmountCantBeZero.selector);
